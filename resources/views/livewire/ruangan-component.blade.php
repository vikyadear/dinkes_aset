<div class="min-h-screen items-center justify-center bg-gray-100 p-2 mb-6">
    <div class="w-full max-w-8xl bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4 text-gray-700">
            <div class="mb-4">
                <div class="relative">
                    <input type="text" id="nama" wire:model="nama" placeholder="Nama ruangan"
                ...
                <table class="min-w-full divide-y divide-gray-200 mt-4">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th style="width: 80%; text-align: center" class="px-3 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">NAMA</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{{$r->nama}}</td>
                            <td style="text-align: center" class="px-3 py-2 whitespace-nowrap text-sm text-gray-900">
                                <button title="Edit" style="cursor: pointer;" class="bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-1 px-3 rounded-lg shadow-md transition duration-200" wire:click="edit({{ $r->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                    </svg>
                                </button>
                                <button title="Delete" style="cursor: pointer;" class="bg-red-600 hover:bg-red-700 text-white font-semibold py-1 px-3 rounded-lg shadow-md transition duration-200" wire:click="delete({{ $r->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="text-center py-4 italic px-3 whitespace-nowrap text-sm text-gray-900">
                                Data tidak ada
                            </td>
                        </tr>
                        @endforelse
